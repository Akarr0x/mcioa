...
from .data_preprocessing import perform_nsc_analysis, transpose_analysis_result, validate_data, perform_pca_analysis, \
    perform_ca_analysis


def dataset_validation_and_analysis_prep(dataset, nf=10, analysis_type ="nsc"):
    """
    ...
    dataset = validate_data(dataset, pos=True)
